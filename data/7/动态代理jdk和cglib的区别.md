动态代理的描述在前两篇文章已经做了一部分描述[动态代理的详细解读](https://www.jianshu.com/p/d332a0684c02)和[动态代理的简单描述](https://www.jianshu.com/p/d7835ab742e7)，**JDK的动态代理只能针对实现了接口的类生成代理。而cglib的动态代理是针对类实现代理，这两种代理我们可以灵活使用。**我们通过汽车跑的例子来解读这两种动态代理。
